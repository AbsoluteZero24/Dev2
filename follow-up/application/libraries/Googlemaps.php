...
class Googlemaps {
    ...
    var $center = "-6.213701, 106.848507";  // Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
    ...
    function add_marker($params = array()) {
        ...
        $marker['latitude'] = '';        // The position (lat/long co-ordinate or address) at which the marker will appear -- seno
        $marker['longitude'] = '';        // The position (lat/long co-ordinate or address) at which the marker will appear -- seno
        ...
        if ($marker['position'] != "") {
            ...
            $this->markersInfo['marker_latitude'] = $marker['latitude'];
            $this->markersInfo['marker_longitude'] = $marker['longitude'];
                $marker_output .= '
