...
$config['collections']['places']         = 'places';
/*
| -------------------------------------------------------------------------
| Tables.
| -------------------------------------------------------------------------
...
$config['tables']['places']          = 'vw_auth_groups';
$config['tables']['users_places']    = 'auth_users_places';

$config['tables']['modules']          = 'auth_modules';
$config['tables']['users_modules']    = 'auth_users_modules';
/*
 ...
 */
$config['site_title']           = "Sistem Informasi Kenavigasian"; 		// Site Title, example.com
$config['admin_email']          = "admin@masnav.com"; 	// Admin Email, admin@example.com
$config['default_group']        = 'operator'; 			// Default group, use name
$config['admin_group']          = 'admin'; 				// Default administrators group, use name
$config['operator_group']       = 'operator'; 				// Default administrators group, use name
$config['report_group']         = 'report'; 				// Default administrators group, use name
$config['approval_group']       = 'approval'; 				// Default administrators group, use name
