...
<div class="col-lg-12 col-md-12 col-sm-12 " style="padding-left:5; padding-right:5;">
    <div class="box box-info">
        ...
        <div class="box-body">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-hover table-responsive" style="border-top:1px solid;border-bottom:1px solid">
                <thead>
                    <tr>
                        ...
                        <th width="100">No.VR</th>
                        <th >Importir</th>
                        <th width="150">VR Date</th>
                        <th  width="250">SPI</th>
                        <th width="200" style="text-align:right; "><a class="green" href="<?php echo site_url() . "/" . $form . "/modify/"; ?>">
                                <!--                            <button style="height:30px" class="btn btn-green btn_space btn-sm" >
                                                                <i class="ace-icon fa fa-plus bigger-130 "></i>
                                                            </button>-->
                            </a></th>
                ...
                <tbody>
                    ...
                    foreach ($header as $p) {
                        ...
                        <tr class="record" id="record<?php echo $p->vr_submit_no; ?>">
                            ...
                            <td data-label="VR Submit No"><?php echo $p->vr_submit_no; ?></td>
                            <td data-label="Importer Name"><?php echo $p->importer_name; ?></td>
                            <td data-label="VR Date"><?php echo format_date($p->vr_submit_date); ?></td>
                            <td data-label="SPI">
            ...
            <div class="action-buttons">
                <a class="green <?php echo $p->sts_register ?> " href="<?php echo site_url() . "/" . $form . "/set_register/" . $p->vr_submit_no; ?>">
                    <button style="height:30px" class="btn btn-primary btn_space btn-sm" >
                ...
                <a class="green hidden" href="<?php echo site_url() . "/" . $form . "/check_quota/" . $p->vr_submit_no; ?>">
                    <button style="height:30px" class="btn btn-primary btn_space btn-sm" >
                ...
                <a class="green hidden" href="<?php echo site_url() . "/" . $form . "/booking_quota/" . $p->vr_submit_no; ?>">
                    <button style="height:30px" class="btn btn-primary btn_space btn-sm">
                        <i class="ace-icon fa fa-check bigger-130">

                        </i>
                        Book Quota
                    </button>
                </a>
                <a class="green hidden" href="<?php echo site_url() . "/" . $form . "/cancel_quota/" . $p->vr_submit_no; ?>">
                    <button style="height:30px" class="btn btn-danger btn_space btn-sm">
                        <i class="ace-icon fa fa-close ">

                        </i>
                        Cancel Quota
                    </button>
                </a>
                <a class="green" href="<?php echo site_url() . "/" . $form . "/modify_import/" . $p->vr_submit_no; ?>">
                    <button style="height:30px" class="btn btn-primary btn-sm" >
                        <i class="ace-icon fa fa-pencil bigger-130 "></i>  Edit
                    </button>
                </a>
                <button style="height:30px"type="button" class="btn btn-primary btn-sm hidden " onclick="proses_vr('<?php echo $p->vr_submit_no; ?>')">
                ...
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu" id="export-menu">
                        <li><a href="<?php echo site_url() . '/' . $form . '/preview_vr/' . $p->vr_submit_no; ?>" target='_blank'>Preview</a></li>
                        <li><a href="<?php echo site_url() . '/' . $form . '/print_vr_to_pdf/' . $p->vr_submit_no; ?>" target='_blank'>PDF Pre</a></li>
                        <li><a href="<?php echo site_url() . '/' . $form . '/print_vr_post_to_pdf/' . $p->vr_submit_no; ?>" target='_blank'>PDF Post</a></li>                                        
                        <li><a href="<?php echo site_url() . '/' . $form . '/download_vr/' . $p->vr_submit_no; ?>">Download</a></li>
                        <li><a href="<?php echo site_url() . '/' . $form . '/email_vr/' . $p->vr_submit_no; ?>">Email</a></li>
                    </ul>
                </div>
...
<script>
    ...
    function proses_check_quota(vr_submit_no)
    {
        $.ajax({
            url: "<?php echo site_url() . '/' . $form . '/check_quota/' ?>",
            type: "GET",
            data: {vr_submit_no: vr_submit_no},
            dataType: "JSON",
            success: function (data)
            {
                $('#kode').text(data.kode);
                $('#spi').text(data.msg);
                $('#refnumber').text('nomor ref');
                $('#detail').text('nomor ref');
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
                alert('Error get data from ajax');
    ...
    function proses_book_quota(vr_submit_no)
    {
        $.ajax({
            url: "<?php echo site_url() . '/' . $form . '/booking_quota/' ?>",
            type: "POST",
            data: {vr_submit_no: vr_submit_no},
            success: function (data)
            {
    ...
    function proses_cancel_quota(vr_submit_no)
    {
        $.ajax({
            url: "<?php echo site_url() . '/' . $form . '/cancel_quota/' ?>",
            type: "POST",
            data: {vr_submit_no: vr_submit_no},
            success: function (data)
            {
