...
//
        $data['data'] = $this->mst_personel_model->get_all();
...
// -- loading tabel utama --
            $main_row = $this->mst_personel_model->as_array()->get($id);
            $data += reformat_main_row_array($this->mst_personel_model, $main_row);


// -- loading tabel child --
//$data_survei = $this->mst_personel_model->get_many_by('id', $data['id']);
...
//            }
    ...
    function delete() {
        ...
        $this->mst_personel_model->delete($id);
        redirect($this->form);
    }
...
//$document = $PHPWord->loadTemplate('d:\draft_ls.docx');
        ...
        $data = $this->mst_personel_model->get_data($tgl);
//        echo '<pre>';
//        print_r($data);
//        return;
