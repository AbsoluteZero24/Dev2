...
<section class="content">
    ...
    <div class="warper container-fluid">
        ...
        <div class="page-header"><h3>Toggle Columns <small>Show / hide columns dynamically</small></h3></div>
        ...
        <div class="page-header"><h3>Extra Info <small>show extra / detailed information</small></h3></div>


        <div class="panel panel-default">
            <div class="panel-heading">Hidden Data</div>
            <div class="panel-body">

                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="hiddendta-datatable">
                    <thead>
                        <tr>
                            <th width="1%"></th>
                            <th>Name</th>
    ...
    <footer class="container-fluid footer">
        Copyright &copy; 2014 <a href="#" target="_blank">Design</a>
