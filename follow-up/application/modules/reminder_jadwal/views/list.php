                ...
                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>Email</th>
                            <th>Mobile</th>
                            <th width="50" class="disabled-sorting text-right"></th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $p) {
                            ...
                            <tr class="record" <?php echo 'id="record' . $p->id . '"'; ?>>
                                ...
                                <td><?php echo $p->tgl_reminder; ?></td>
                                <td><?php echo $p->jam_reminder; ?></td>
                                <td><?php echo $p->by_wa; ?></td>
                                <td><?php echo $p->by_email; ?></td>
                                <td><?php echo $p->by_mobile; ?></td>
