...
//
        $data['data'] = $this->tbl_cabang_model->get_all();
...
// -- loading tabel utama --
            $main_row = $this->tbl_cabang_model->as_array()->get($id);
            $data += reformat_main_row_array($this->tbl_cabang_model, $main_row);
...
// -- update tabel utama ---------
            if ($id == '') {
                $id = $this->tbl_cabang_model->insert($post);
            } else {
                $this->tbl_cabang_model->update($id, $post);
            }
...
//            }
    ...
    function delete() {
        ...
        $this->tbl_cabang_model->delete($id);
        redirect($this->form);
    }
