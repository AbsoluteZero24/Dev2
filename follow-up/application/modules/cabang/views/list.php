                ...
                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($data as $p) {
                            ...
                            <tr class="record" <?php echo 'id="record' . $p->id_cabang . '"'; ?>>

                                <td><?php echo $i; ?></td>
                                <td><?php echo $p->nm_cabang; ?></td>
                                <td><?php echo $p->nm_pimpinan; ?></td>
                                <td><?php echo $p->id_kode; ?></td>
                                <td style="text-align: center; ">
                                    <div >
                                        <a class="green" href="<?php echo site_url() . "/" . $form . "/modify/" . $p->id_cabang; ?>">
                                            <i class="ace-icon fa fa-pencil bigger-130 text-success"></i>
                                        </a>
                                        <a class="green" href="javascript:;" onclick="return hapus('<?php echo $p->id_cabang; ?>');">
